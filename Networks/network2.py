...
class Net(nn.Module):
	...
	def __init__(self):
		...
		for child in list(resnet.children())[3:8]:
	...
	def forward(self, frame0, frameT, depth0, depthT):

		frame0 = torch.cat((frame0, depth0), 1)
		frameT = torch.cat((frameT, depthT), 1)
		...
		frameT = self.down1(frameT)
		frameT = self.down2(frameT)
		frameT = self.down3(frameT)
		frameT = self.down4(frameT)

		frame0_4 = torch.cat((frame0_4, frameT), 1)
		frame0_4 = self.up4(frame0_4)
		frame0_3 = torch.cat((frame0_4, frame0_3), 1)
		frame0_3 = self.up3(frame0_3)
		frame0_2 = torch.cat((frame0_3, frame0_2), 1)
		frame0_2 = self.up2(frame0_2)
		frame0_1 = torch.cat((frame0_2, frame0_1), 1)
		frame0_1 = self.up1(frame0_1)
		frame0 = torch.cat((frame0_1, frame0), 1)
